...
class GrayscaleConv2d(torch.nn.modules.conv._ConvNd):
    ...
    def forward(self, input):
        return self.grayscale_conv2d_forward(input, self.weight, self.grayscale)


# Clean Convolution
def grayscale_conv2d(input, weight, grayscale_func, bias=None, stride=(1,1), padding=(0,0), dilation=(1,1), groups=1):
    """
...
class GrayscaleEuclideanColorInvariantConv2d(torch.nn.modules.conv._ConvNd):
    def __init__(
        self,
        in_channels,
        out_channels,
        ...
        padding = _pair(padding)
        dilation = _pair(dilation)
        super(GrayscaleEuclideanColorInvariantConv2d, self).__init__(
            in_channels,
            out_channels,
            kernel_size,
            stride,
    ...
    def conv2d_forward(self, input, weight):
        return grayscale_euclidean_conv2d(
            input,
            weight,
            self.grayscale,
            self.bias,
...
def grayscale_euclidean_conv2d(
    input,
    weight,
    grayscale_func,
    bias=None,
